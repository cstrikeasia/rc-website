const discordChannelSvg = {
    ...
    '15': `<path fill="currentColor" d="M18.91 12.98a5.45 5.45 0 0 1 2.18 6.2c-.1.33-.09.68.1.96l.83 1.32a1 1 0 0 1-.84 1.54h-5.5A5.6 5.6 0 0 1 10 17.5a5.6 5.6 0 0 1 5.68-5.5c1.2 0 2.32.36 3.23.98Z"></path> <path fill="currentColor" d="M19.24 10.86c.32.16.72-.02.74-.38L20 10c0-4.42-4.03-8-9-8s-9 3.58-9 8c0 1.5.47 2.91 1.28 4.11.14.21.12.49-.06.67l-1.51 1.51A1 1 0 0 0 2.4 18h5.1a.5.5 0 0 0 .49-.5c0-4.2 3.5-7.5 7.68-7.5 1.28 0 2.5.3 3.56.86Z"></path>`,
};

const privateChannelLockPath = `<path fill="currentColor" d="M16 4h.5v-.5a2.5 2.5 0 0 1 5 0V4h.5a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Zm4-.5V4h-2v-.5a1 1 0 1 1 2 0Z"></path>`;

export function getDiscordChannelSvg(guildId: string, channelId: string, channelName: string, type: string, isPrivate: boolean | string): string {
    let svgPath = discordChannelSvg[type as keyof typeof discordChannelSvg] || '';

    if (type !== '4' && (isPrivate === "1" || isPrivate === true)) {
        if (svgPath) {
            svgPath += " ";
        }
        svgPath += privateChannelLockPath;
    }
