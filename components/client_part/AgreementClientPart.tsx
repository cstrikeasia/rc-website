  ...
  const rules = [
    ...
    },
    {
      ...
      content: [
        ...
        "本軟體可能使用的協力廠商軟體或技術，業經合法授權。因協力廠商軟體或技術引發的任何糾紛，將由該協力廠商負責解決，乙方並不承擔任何責任。乙方不對協力廠商軟體或技術提供客服支援，若甲方需要取得支援，請逕與該軟體或技術提供商聯繫。",
    ...
    },
    {
      ...
      content: [
        ...
        "九、在沒有獲得乙方授權的情況下，任何用戶不得以文字、語音、圖片等形式在乙方平臺內宣傳推廣其他同類平臺（包括但不限於娛樂直播類平臺、遊戲類平臺、語音工具等），任何用戶不得協助其他同類平臺取得乙方平臺內部資訊及資源（包括但不限於內部經營模式、內部經營規則、用戶資訊、主播資訊、公會資訊等）。乙方有權對以上違規用戶進行個人封號、撤銷語音群許可權等內部處理。對用戶涉及違法的行為，保留法律追溯權利。",
